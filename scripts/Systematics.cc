...
float Systematics::leptonRecoIDEffCorr() const
{
        ...
        for(int i = 0; i < 4; ++i){
            ...
            eff_weight_corr *= (eff_weight + ele_scale_2012->GetBinError(binx,biny) * _data_to_mc_random_id_e);
...
//            cout << "electron (pt = " << Pt << ", eta = " << Eta << " ) out of range" << endl;
            ...
            eff_weight_corr *= (eff_weight + mu_scale_2011->GetBinError(binx,biny) * _data_to_mc_random_syst_mu);
            } else {
	      //            cout << "muon (pt = " << Pt << ", eta = " << Eta << " ) out of range" << endl;
            ...
            eff_weight_corr *= (eff_weight + mu_scale_2012->GetBinError(binx,biny) * _data_to_mc_random_syst_mu);
            } else {
	      //            cout << "muon (pt = " << Pt << ", eta = " << Eta << " ) out of range" << endl;
            }
            }
